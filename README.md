...
**Next steps for Mark:** open **Clip Studio** (`/studio`), pick Murphy or Riley, frame source photos, **Suggest prompt** → **Copy** into Grok Imagine (or Pika), and attach MP4s. See [`docs/CLIP_STUDIO.md`](docs/CLIP_STUDIO.md). Ken Burns photo mode stays as fallback until dual-mode is complete.
